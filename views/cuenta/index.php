    ...
    <div class="row gap-5">
        ...
        <div class="col shadow-lg p-3 mb-5 bg-body rounded">
            <div class="card mb-2" style=" width: 370px; max-height: 380px;">
                ...
                <div class="d-grid">
                    <a href="/panel/buscar" class="btn btn-primary btn-lg  ">Buscar</a>
                </div>
            </div>
        </div>
        <div class="col shadow-lg p-3 mb-5 bg-body rounded ">
            <div class="card mb-2" style="width: 370px; max-height: 380px;">
                ...
                <div class="d-grid">
                    ...
                    <a href="/panel/agregar" class="btn btn-success btn-lg  ">Agregar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col shadow-lg p-3 mb-5 bg-body rounded">
            <div class="card mb-2" style="width: 370px; max-height: 380px;">
                ...
                <div class="d-grid">
                    ...
                    <a href="/panel/actualizar" class="btn btn-secondary btn-lg  ">Actualizar</a>
                </div>
            </div>
        </div>
        <div class="col shadow-lg p-3 mb-5 bg-body rounded">
            <div class="card mb-2" style="width: 370px; max-height: 380px;">
                ...
                <div class="d-grid">
                    ...
                    <a href="/panel/eliminar" class="btn btn-danger btn-lg  ">Eliminar datos</a>
                </div>
            </div>
        </div>
        ...
        <div class="col shadow-lg p-3 mb-5 bg-body rounded" >
            <div class="card mb-2" style="width: 370px; max-height: 380px;">
                ...
                <div class="d-grid">
                    ...
                    <a href="/panel/admin" class="btn btn-warning btn-lg  ">Panel de administracion</a>
                </div>
            </div>
        </div>
        ...
        <div class="col shadow-lg p-3 mb-5 bg-body rounded" >
            <div class="card mb-2" style="width: 370px; max-height: 380px;">
                <img src="https://www.svgrepo.com/show/217141/admin.svg" class="card-img-top mx-auto" alt="..." style="max-width: 200px;">
                <div class="card-body">
                ...
                <div class="d-grid">
                    ...
                    <a href="#" class="btn btn-secondary btn-lg  ">Configuraciones</a>
                </div>
            </div>
        </div>
